...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const aaa = yield octokit.git.getRef(Object.assign(Object.assign({}, repoInfo), { ref: head.sha }));
    console.log("======sadsad", aaa);
    yield octokit.git.updateRef(Object.assign(Object.assign({}, repoInfo), { ref: head.sha, sha: newCommit.data.sha }));
    console.log("done");
});
run();
