...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all((contents.data || []).map(file => {
        return axios_1.default({
            ...
            fs.writeFileSync(p, new Buffer(response.data, "binary"));
    ...
    const blob = yield octokit.git.createBlob(Object.assign(Object.assign({}, repoInfo), { content }));
    ...
    yield octokit.git.updateRef(Object.assign(Object.assign({}, repoInfo), { ref: ref.replace("refs/", ""), sha: newCommit.data.sha }));
    console.log("done");
});
