...
console.log("base", event.pull_request.base, event.pull_request.head);
console.log(child_process_1.execSync(`git merge-base refs/heafs/${event.pull_request.base.ref} refs/heads/${event.pull_request.head.ref}`));
if (!event) {
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let branch = yield octokit.repos
        .getBranch(Object.assign(Object.assign({}, repo), { branch: "gh-pages" }))
        .catch(e => {
        console.log(e);
        return null;
    });
    ...
    const ref = branch
        ? branch.data.name
        : (yield octokit.git.createRef(Object.assign(Object.assign({}, repo), { ref: "refs/heads/gh-pages", sha: headCommit.data.sha }))).data.ref;
    console.log(ref);
    ...
    //   sha: blob.data.sha
    // });
    const newTree = yield octokit.git.createTree(Object.assign(Object.assign({}, repo), { tree: [
            ...tree.data.tree
            // {
            //   path: "image.png",
            //   mode: "100644",
    ...
    const newCommit = yield octokit.git.createCommit(Object.assign(Object.assign({}, repo), { tree: newTree.data.sha, message: "Test", parents: [branch.data.commit.sha] }));
    console.log("ref", ref);
