...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // });
    // console.log("===============asdaa==");
    octokit.git.createRef(Object.assign(Object.assign({}, repoInfo), { ref: "refs/heads/gh-pages-d", sha: headCommit.data.sha }));
    tree.data.tree.pop();
    tree.data.tree.push({
        path: "aaaaaaasad",
        mode: "100644",
    ...
    //   ref: head.data.sha
    // });
    yield octokit.git.updateRef(Object.assign(Object.assign({}, repoInfo), { ref: head.ref.replace("refs/", ""), sha: newCommit.data.sha }));
    console.log("done");
});
run();
