...
var createHTMLReport = function createHTMLReport(params) {
  ...
  var js = _fs2.default.readFileSync(_path2.default.join(__dirname, '../report/dist/build.js'));
  ...
  var json = {
    ...
    actualDir: '' + params.urlPrefix + _path2.default.relative(_path2.default.dirname(params.report), params.actualDir),
    expectedDir: '' + params.urlPrefix + _path2.default.relative(_path2.default.dirname(params.report), params.expectedDir),
    diffDir: '' + params.urlPrefix + _path2.default.relative(_path2.default.dirname(params.report), params.diffDir),
    ximgdiffConfig: {
...
function createXimdiffWorker(params) {
  ...
  var moduleJs = _fs2.default.readFileSync(_path2.default.join(__dirname, '../report/dist/worker.js'), 'utf8');
